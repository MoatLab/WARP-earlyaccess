...
blks_per_pl=1021 	#4MB * 8 * 8 =RU 256MiB -> 1021 = (224*1.14*1024)/256   #! WAF DIFF
...
sudo x86_64-softmmu/qemu-system-x86_64 \
    ...
    -smp 16 \
    -m 8G \
    -device femu-subsys,id=femu-subsys-0,nqn=subsys0,fdp=on,fdp.nruh=8,fdp.nrg=1,fdp.nru=${number_of_ru},fdp.isolation_mode=0 \
