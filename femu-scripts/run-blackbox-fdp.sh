...
pgs_per_blk=512 	#16*128:2048KiB, 256:4MiB 512:8MB
blks_per_pl=537 	#2G   256*1.2 = 307                 //2MB * 8 * 8 =RU 128MiB -> 2150 = (224*1.2*1024)/128     
pls_per_lun=1       # still not support multiplanes		
luns_per_ch=8		# 16G                256*8
nchs=8  			# 128G              256*8*8
ssd_size=229376		# in MegaBytes  
                    #    128GiB ( 156GiB )
                    #    256GiB ( 307GiB)   262144
                    #    512GiB ( 614GiB)   524288 

# secsz=512		
# secs_per_pg=8		#4KiB 
# pgs_per_blk=512 	#512*4K:2MB (RU : 128MiB)
# blks_per_pl=2151 	#2MB * 8 * 8 =RU 128MiB -> 2150 = (224*1.2*1024)/128     
# pls_per_lun=1       # still not support multiplanes		
# luns_per_ch=8		# 16G                256*8
# nchs=8  			# 128G              256*8*8
# ssd_size=229376		# in MegaBytes  
...
#ch_xfer_lat=0
pg_rd_lat=10000   # 40us   : 10us   : 0.4us
pg_wr_lat=5000    # 500us  : 50us   : 5us
blk_er_lat=20000  # 2000us : 200us  : 20us
ch_xfer_lat=0
# GC Threshold (1-100)
gc_thres_pcent=90
